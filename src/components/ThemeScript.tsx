...
var c=(t==='royal'||t==='gold'||t==='silver')?t:localStorage.getItem('mcqure-theme-color');
if(c!=='teal'&&c!=='purple'&&c!=='blue-gold'&&c!=='claude'&&c!=='gold'&&c!=='silver'&&c!=='royal'&&c!=='custom')c='teal';
